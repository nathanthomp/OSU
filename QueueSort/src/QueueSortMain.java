...
public final class QueueSortMain {
    ...
    /**
     * Compare {@code String}s in non-lexicographic order.
     */
...
//        String fileName = in.nextLine();
        String fileName = "data/lines.txt";
        ...
        /*
         * Sort lines into increasing lexicographic order
         */
        ...
        /*
         * Sort lines into decreasing lexicographic order
         */
        Comparator<String> gt = new StringGT();
        q.sort(gt);
