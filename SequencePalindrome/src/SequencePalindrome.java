...
//
//        // base case of |s| < 2 = true
//        if (s.length() < 2) {
//            result = true;
//        } else {
//            // check the first and last elements
//            // if they are the same, remove each and call recursive
//            // else result = false
//            int index = s.length();
//            int last = s.remove(index - 1);
...
//        return result;
        ...
        boolean result = false;
        Sequence<Integer> sCopy = new Sequence1L<>();
        Sequence<Integer> cache = new Sequence1L<>();
