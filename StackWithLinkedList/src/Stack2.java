...
public class Stack2<T> extends StackSecondary<T> {
    ...
    public final void push(T x) {
        ...
        /*
         * Step 1: Create a new node and hold the current top.
         */
        Node p = new Node();
        Node q = this.top;
        /*
        ...
        p.data = x;
        /*
         * Step 3: Assign the new top.
         */
        this.top = p;
        /*
         * Step 4: Assign the next of the new node to the old top.
         */
        p.next = q;
        /*
         * Step 5: Increment the length of $this.
         */
        this.length++;
