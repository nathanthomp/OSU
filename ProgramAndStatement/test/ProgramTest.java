...
public abstract class ProgramTest {
    ...
    private static final String[] FILE_NAMES = {
            "data/programs/program-sample.bl", "data/programs/halfAndHalf.bl",
            "data/programs/randomWalk.bl", "data/programs/zigzag.bl",
            "data/programs/manyIfStatements.bl" };
    ...
    public final void testName() {
        for (String fileName : FILE_NAMES) {
             ...
             * Setup
             */
            Program pTest = this.createFromFileTest(fileName);
            Program pRef = this.createFromFileRef(fileName);
    ...
    public final void testSwapContext() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAMES[0]);
        Program pRef = this.createFromFileRef(FILE_NAMES[0]);
    ...
    public final void testSwapBody() {
        for (String fileName : FILE_NAMES) {
            ...
            /*
             * Make the reference call, replacing, in pRef, remaining with
             * first:
             */
            pRef.swapBody(bodyRef);
