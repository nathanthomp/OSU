...
public abstract class StatementTest {
     ...
     */
    private static final String FILE_NAME_1 = "data/statements/statement-sample.bl";
    ...
    /**
     * Test removeFromBlock at the front leaving no block behind.
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingEmpty() {
         ...
         * Setup
         */
        Statement sTest = this.createFromFileTest("data/statements/single.bl");
        Statement sRef = this.createFromFileRef("data/statements/single.bl");
        Statement nestedRef = sRef.removeFromBlock(0);
    ...
    public final void testLengthOfBlockEmpty() {
        ...
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
        Statement sRef = this.createFromFileRef(FILE_NAME_1);
        Statement emptyBlock = sTest.newInstance();
        int lengthRef = emptyBlock.lengthOfBlock();
