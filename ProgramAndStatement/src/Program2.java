...
public class Program2 extends ProgramSecondary {
    ...
    public final Map<String, Statement> newContext() {
        /*
         * Create and return a new instance of the Map1L class.
         */
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Create a Map to store context temporarily. We can instantiate a Map1L
         * class because the requires clause states that c must be the same type
         * of $this.newContext.
         */
        Map<String, Statement> temp = new Map1L<>();
        /*
         * Assign the new incoming context c to temp.
         */
        temp.transferFrom(c);
        /*
         * Transfer #$this.context to c.
         */
        c.transferFrom(this.context);
        /*
         * Finally, assign $this.context as temp
         */
        this.context = temp;
    }
    ...
    public final Statement newBody() {
        /*
         * Create and return a new instance of the Statement1 class.
         */
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Create a Statement to store context temporarily. We can instantiate a
         * Statement1 class because the requires clause states that c must be
         * the same type of $this.newBody.
         */
        Statement temp = new Statement1();
        /*
         * Assign the new incoming body b to temp.
         */
        temp.transferFrom(b);
        /*
         * Transfer #$this.body to b.
         */
        b.transferFrom(this.body);
        /*
         * Finally, assign $this.body as temp.
         */
        this.body = temp;
    }
