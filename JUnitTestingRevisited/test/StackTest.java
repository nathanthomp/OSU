...
public abstract class StackTest {
    ...
    private Stack<String> createFromArgsTest(String... args) {
        ...
        // Create the stack based on the constructorTest return type
        Stack<String> result = this.constructorTest();

        // Add every element from args to the stack
    ...
    private Stack<String> createFromArgsRef(String... args) {
        ...
        // Create the stack based on the constructorRef return type
        Stack<String> result = this.constructorRef();
