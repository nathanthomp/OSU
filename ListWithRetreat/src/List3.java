...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        /*
         * Create: preStart node (node1), postFinish node (node2).
         */
        Node node1 = new Node();
        Node node2 = new Node();

        /*
         * Assign $this.preStart as node1 and $this.postEnd as node2. Then
         * populate the node's references and data.
         */
        this.preStart = node1;
        this.preStart.next = node2;

        this.postFinish = node2;
        this.postFinish.previous = node1;

        /*
         * Assign data to $this.lastLeft.
         */
        this.lastLeft = node1;

        /*
         * Assign data of 0 to $this.leftLength and $this.rightLength.
         */
        this.leftLength = 0;
        this.rightLength = 0;
    }
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Step 3: Fill in node data.
         */
        node.data = x;

        /*
         * Step 4: Assign node.previous to $this.lastLeft to place right at
         * beginning of $this.right.
         */
        node.previous = this.lastLeft;

        /*
         * Step 5: Assign node.next as the previous next of $this.lastLeft.
         */
        node.next = this.lastLeft.next;

        /*
         * Step 6: Assign the previous of node after the added node.
         */
        this.lastLeft.next.previous = node;

        /*
         * Step 8: Assign $this.lastLeft.next as the new node.
         */
        this.lastLeft.next = node;
    ...
    public final T removeRightFront() {
        ...
        /*
         * Get the node's data to return.
         */
        Node resultNode = this.lastLeft.next;
        T result = resultNode.data;

        /*
         * Update $this.lastLeft.next.
         */
        this.lastLeft.next = resultNode.next;

        /*
         * Update $this.lastLeft.next.previous.
         */
        this.lastLeft.next.previous = resultNode.next.previous.previous;

        /*
         * Decrement $this.rightLength.
         */
        this.rightLength--;
    ...
    public final void advance() {
        ...
        /*
         * Update $this.leftLength and $this.rightLength.
         */
        this.leftLength++;
        this.rightLength--;

        /*
         * Update this.lastLeft.
         */
    ...
    public final void moveToStart() {
        ...
        int totalLength = this.leftLength + this.rightLength;

        /*
         * Update $this.leftLength and $this.rightLength.
         */
        this.leftLength = 0;
        this.rightLength = totalLength;
