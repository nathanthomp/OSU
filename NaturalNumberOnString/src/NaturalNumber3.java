...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public NaturalNumber3(int i) {
        ...
        // the representation of 0 is an empty string
        this.createNewRep();
        if (i > 0) {
            this.rep = Integer.toString(i);
        } else {
            //if the value of i is zero, make its representation an empty string
            this.rep = "";
        }
    }
    ...
    public final void multiplyBy10(int k) {
        ...
        //put the new digit to the right of the rest of the digits
        this.rep = this.rep + k;
    }
    ...
    public final int divideBy10() {
        ...
        //remove the rightmost digit and return it

        //get the rightmost digit
        int right = Integer.parseInt(this.rep.substring(len - 1, len));
