...
public class Sequence3<T> extends SequenceSecondary<T> {
    ...
    public final void add(int pos, T x) {
        ...
        // To add an element to the sequence, move right stack over to left stack
        // by the value of pos. Then we can push the value of T to the right stack.
    ...
    public final T remove(int pos) {
        ...
        // To remove the element at pos, we must move the right stack over to left
        // stack by the value of pos. Then we can pop the right stack to return the
        // value of T.
        setLengthOfLeftStack(this.left, this.right, pos);
        T x = this.right.pop();
