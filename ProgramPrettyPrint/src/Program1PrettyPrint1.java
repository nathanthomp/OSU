...
public final class Program1PrettyPrint1 extends Program1 {
    ...
    public void prettyPrint(SimpleWriter out) {
        ...
        // data/SampleProgram.bl

        /*
         * Print the first PROGRAM line. Then print the INSTRUCTIONS BLOCK. Then
         * the BEGIN line. Then the MAIN BLOCK. Then the END line.
         */
        ...
        for (Map.Pair<String, Statement> instruction : context) {
            ...
            instruction.value().prettyPrint(out, INDENT_SIZE * 2);
